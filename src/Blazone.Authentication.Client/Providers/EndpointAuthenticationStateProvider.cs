...
public class EndpointAuthenticationStateProvider : AuthenticationStateProvider
{
    ...
    private readonly ILogger<EndpointAuthenticationStateProvider> _logger;
    private readonly AuthenticationEndpointOptions _authenticationOptions;
    private readonly IMemoryCache _memoryCache;

    public EndpointAuthenticationStateProvider(
        HttpClient httpClient,
        ILogger<EndpointAuthenticationStateProvider> logger,
    ...
    private async Task<ClaimsPrincipal> LoadUser(ICacheEntry cacheEntry)
    {
        ...
        var identity = new ClaimsIdentity(
            claims: claims,
            authenticationType: nameof(EndpointAuthenticationStateProvider),
